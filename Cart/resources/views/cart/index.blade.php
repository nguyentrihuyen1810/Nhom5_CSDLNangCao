...
<div style = "width: 1000px; margin-top: 50px; height: auto; margin-left: 100px; float: left">
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><h6 style="margin-top: 60px; margin-left: 20px">{{$cart->quantity}}</h6></td>
            <td><h6 style="margin-top: 60px; margin-left: 8px">${{$cart->total}}</h6></td>
        </tr>
        @endforeach
        </tbody>
    </table>
...
{{--        <p class="card-text">Subtotals &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$869 </p>--}}
