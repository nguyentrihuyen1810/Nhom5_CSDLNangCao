...
<div style="padding: 20px; margin-top: 20px; width: 100%; border: 1px solid #777777">
    ...
    <a>Home / </a><a style="color:#43A316">Shop /</a><a style="color:#43A316"> Smartwatch </a>
</div>
    ...
    <div>
        @foreach ($product as $product)
            <div class="card" style="width: 210px; height:320px;  margin: 0 0 40px 40px; float: left">
                ...
                <div class="card-body">
                    <a href="/showus/{{$product->name}}" style = "text-decoration: none; color: black; margin-left: 70px"><h5 style = "text-align: center" class="card-title">{{ $product->name }}</h5></a>
