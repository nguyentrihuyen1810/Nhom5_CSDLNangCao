...
<form style="width: 100%; margin-top: 50px" action = "/shop/show/<?php echo e($product->name); ?>" method="get" class="row g-3">
    ...
    <div style="width:50%; float: left; padding: 65px 20px 0 20px; ">
        <h4 style="margin-bottom: 50px; color:red">Giá: $<?php echo e($product->price); ?></h4>
        <p>Số lượng: <?php echo e($product->quantity); ?> </p><br>
        <p>Loại sản phẩm: <?php echo e($product->Category_id); ?> </p><br>
...
<?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDC_NC1\Mobile\resources\views/showad.blade.php ENDPATH**/ ?>