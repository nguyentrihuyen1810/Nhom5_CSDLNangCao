...
<form style="width: 25%; margin-left: 500px; margin-top: 50px" action="/addregister" method="post">
  ...
  <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 150px; margin-left: 6px; float: left; margin-top: 25px">Register</button>
</form>
<button class="btn btn-success" style="background: white; color: #333333; width: 150px; margin-left: 20px; margin-top: 25px"><a style="text-decoration: none; color: black" href="/home">Back</a></button>
...
<?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDL_NC\Mobile\resources\views/register.blade.php ENDPATH**/ ?>