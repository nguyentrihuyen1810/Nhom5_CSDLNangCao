...
<div class="header">
    <div class="header1">
        <ul>
            ...
            <li>
                <div class = "headerTitle" style="margin-top: 8px; margin-left: 650px">
                    <i  style="color:white; font-size:30px" class="bi bi-person"></i>
                </div>
                <?php if(session('customer')): ?>
                    <a href="/profile/{username}"><p style="float: left; margin-left: 15px ;color:white;margin-top:20px"><?php echo e(session('customer')->username); ?></p></a>
                <?php endif; ?>
            </li>
        </ul>
    </div>
    <div class="col-4 nav" style="width: 100%;">
        ...
        <ul style="margin-top: 40px;margin-bottom: 0px;">
            ...
            <li><a href="/userad">CUSTOMERS</a></li>
            <li><a href="/shopad">PRODUCTS</a></li>
...
<?php /**PATH D:\Xampp1\htdocs\CSDLNangCao\Mobile\resources\views/headerAdmin.blade.php ENDPATH**/ ?>