...
<form style="width: 70%; margin-left: 350px; margin-top: 50px" action = "/update/<?php echo e($product->name); ?>" method="post" class="row g-3">
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDL_NC\Mobile\resources\views/edit.blade.php ENDPATH**/ ?>