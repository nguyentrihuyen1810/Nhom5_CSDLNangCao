            ...
            <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/showad/<?php echo e($product->name); ?>">
                            <button class="Show">Show</button>
                        </a>
                        

                        <a  href="/edit/<?php echo e($product->name); ?>"><button  class="Edit">Edit</button></a>
                        <a  href="/delete/<?php echo e($product->name); ?>"onclick="return confirm('confirm delete?')"><button  class="Delete">Delete</button></a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDC_NC1\Mobile\resources\views/product/indexad.blade.php ENDPATH**/ ?>