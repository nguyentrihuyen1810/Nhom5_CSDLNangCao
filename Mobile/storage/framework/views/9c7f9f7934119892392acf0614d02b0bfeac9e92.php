...
<form style="width: 25%; margin-left: 500px; margin-top: 50px" action="/addregister" method="post">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
  ...
  <div class="mb-3" style="margin-top: 30px">
    <label for="exampleInputEmail1" class="form-label"><b>Adress:</b></label>
  ...
  <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 150px; margin-left: px; float: left; margin-top: 25px">Register</button>
</form>
<button class="btn btn-success" style="background: white; color: #333333; width: 150px; margin-left: 15px; margin-top: 25px"><a style="text-decoration: none; color: black" href="/login">Back</a></button>
...
<?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDC_NC1\Mobile\resources\views/user/register.blade.php ENDPATH**/ ?>