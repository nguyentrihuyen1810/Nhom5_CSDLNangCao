...
<form style="width: 100%; margin-top: 30px" action = "/profile/<?php echo e($user->username); ?>" method="get" class="row g-3">
...
<a href="<?php echo e(url('/profile/edit', $user->username)); ?>"><button style="width: 200px; background-color: #43A316 ; margin-left: 650px; margin-top: 10px; margin-bottom: 50px" class="Edit">Edit</button></a></div>
...
<?php /**PATH D:\Xampp1\htdocs\CSDLNangCao\Mobile\resources\views/customer/show.blade.php ENDPATH**/ ?>