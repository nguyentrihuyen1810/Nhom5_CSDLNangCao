        ...
        <ul>
            ...
            <li>
                ...
                <?php if(session('customer')): ?>
                    <p style="float: left; margin-left: 15px ;color:white;margin-top:20px"><?php echo e(session('customer')->username); ?></p>
                <?php endif; ?>
            </li>
        </ul>
    </div>
...
<?php /**PATH C:\xampp\htdocs\CODE\Laravel\CSDC_NC1\Mobile\resources\views/headerAdmin.blade.php ENDPATH**/ ?>