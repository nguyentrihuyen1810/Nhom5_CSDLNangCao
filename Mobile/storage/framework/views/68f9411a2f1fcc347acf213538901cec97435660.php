...
<div class="mb-3" style="margin-top: 30px">
  ...
  <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 150px; margin-left: 6px; float: left; margin-top: 25px">Login</button>
</form>
<button class="btn btn-success" style="background: white; color: #333333; width: 150px; margin-left: 20px; margin-top: 25px"><a style="text-decoration: none; color: black" href="/register">Register</a></button>
...
<?php /**PATH C:\xampp\htdocs\mobile\mobile\resources\views//login.blade.php ENDPATH**/ ?>