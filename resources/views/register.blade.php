...
<form style="width: 25%; margin-left: 580px; margin-top: 50px" action="/register" method="post">
    @csrf
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 180px; float: left; margin-top: 25px">Register</button>
</form>
<button class="btn btn-success" style="background: white; color: #333333; width: 180px; margin-left: 20px; margin-top: 25px; margin-bottom: 50px"><a style="text-decoration: none; color: black" href="{{url('/login')}}">Back</a></button>
