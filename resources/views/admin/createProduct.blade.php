...
<div class="home_content">
    ...
    <form style="width: 80%; margin-left: 400px; margin-top: 50px">
            <div class="col-md-6" style="float: left; width: 40%">
                <label for="inputEmail4" class="form-label">Name</label>
                <input type="text" placeholder="Product name..." class="form-control" id="inputEmail4">
            </div>
            <div class="col-md-6" style="float:left; margin-left: 20px; width: 20%">
                <label for="inputPassword4" class="form-label">Price</label>
                <input type="text" placeholder="Product price..." class="form-control" id="inputPassword4">
            </div>
        ...
        <div class="btn_content" style="margin-left: -450px; margin-top: 50px">
            <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 170px; margin-left: 600px; float: left; margin-top: 25px">Create</button>
            <button type="reset" class="btn btn-success" style="background: white; color: #333333; width: 170px; margin-left: 20px; margin-top: 25px"><a style="text-decoration: none; color: black" href="{{url('/admin')}}">Back</a></button>
        </div>
    </form>
</div>
