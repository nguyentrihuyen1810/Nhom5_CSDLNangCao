...
<div class="home_content">
    <section>
        <b><h2 style="text-align: center; padding-top: 50px">PRODUCT MANAGEMENT</h2></b>
        <div class ="addsp">
            <ul class=addsp1>
            ...
            <table class="table table-hover">
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>
                            <form style="float: left; margin-left:15px; " action="/delete/{{$product->code}}" method="post" onclick="return confirm('Confirm delete?')">
                                @csrf
                                <button type="submit" style="width: 100px" class="Delete">Delete</button>
                            </form>
                            <a href="{{url('/admin/edit', $product->code)}}"><button style="width: 100px" class="Edit">Edit</button></a>
                        </td>
                    </tr>
                @endforeach
            </table>
