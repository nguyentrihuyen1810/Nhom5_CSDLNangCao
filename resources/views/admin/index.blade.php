            ...
            <table>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>
                            <form style="float: left; margin-left:15px; " action="/delete/{{$product->name}}" method="post" onclick="return confirm('Confirm delete?')">
                                @csrf
                                <button type="submit" style="width: 100px" class="Delete">Delete</button>
                            </form>
                            <a href="{{url('/admin/edit', $product->name)}}"><button style="width: 100px" class="Edit">Edit</button></a>
                        </td>
                    </tr>
                @endforeach
            </table>
