...
<h3 style="text-align: center; margin-top: 100px"><b>ADD USER</b></h3>
<form style="width: 70%; margin-left: 450px; margin-top: 50px" action = "" method="post" class="row g-3">
    @csrf
    ...
    <div class="col-md-6" style="float: left; width: 45%; margin-left: 100px">
        ...
        <input type="email" name = "email"  placeholder="Product name..." class="form-control" id="inputEmail4">
    </div>

    <div class="submit_btn" style="margin-left: 150px">
        <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 170px;margin-top: 25px;">Create</button>
        <a style="border: none; background-color: white; width: 170px; color: #43A316; border: 1.5px solid #43A316; margin-top: 25px; margin-left: 20px" class="btn btn-primary" href="{{url('/listUser')}}" role="button">Back</a>
    </div>
