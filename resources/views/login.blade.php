...
<form style="width: 25%; margin-left: 580px; margin-top: 50px" action="/checkLogin" method="post">
    @csrf
    ...
    <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 170px; float: left; margin-top: 25px">Login</button>
</form>
    <button class="btn btn-success" style="background: white; color: #333333; width: 170px; margin-left: 38px; margin-top: 25px"><a style="text-decoration: none; color: black" href="{{url('/register')}}">Register</a></button>
