...
<form style="width: 25%; margin-left: 580px; margin-top: 50px" action="/checkLogin" method="post">
    ...
    <button class="btn btn-success" style="background: white; color: #333333; width: 170px; margin-left: 38px; margin-top: 25px"><a style="text-decoration: none; color: black" href="/home">Back</a></button>
</form>
