...
<form style="width: 70%; margin-left: 450px; margin-top: 50px" action = "/profile/update/{{$user->id}}" method="post" class="row g-3">
    @csrf
    ...
    <div class="submit_btn" style="margin-left: 150px">
        ...
        <a style="border: none; background-color: white; width: 170px; color: #43A316; border: 1.5px solid #43A316; margin-top: 25px; margin-left: 20px" class="btn btn-primary" href="{{url('/profile', $user->id)}}" role="button">Back</a>
    </div>
</form>
