...
@include('header')
<form style="width: 100%; margin-top: 30px" action = "/profile/{{$user->id}}" method="get" class="row g-3">
...
<a href="{{url('/profile/edit', $user->id)}}"><button style="width: 200px; background-color: #43A316 ; margin-left: 650px; margin-top: 10px; margin-bottom: 50px" class="Edit">Edit</button></a></div>
