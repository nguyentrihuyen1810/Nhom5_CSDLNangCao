...
<div style="width:85%;float: left; padding: 10px 20px; margin-top: 30px; border-left: 1px solid #777777">
    <div>
        ...
        <div class="card" style="width: 210px; height:320px;  margin: 0 0 40px 40px; float: left">
            <div class="card-body">
                <a href="/show/{{$product->name}}" style = "text-decoration: none; color: black; margin-left: 70px"><h5 style = "text-align: center" class="card-title">{{ $product->name }}</h5></a>
                <p style = "color: #DD4466; text-align: center" class="card-text"><b>${{ $product->price }}</b></p>
                <p style = "color: #DD4466; text-align: center" class="card-text"><b>{{$product->category->name}}</b></p>
                <p style = "color: #DD4466; text-align: center" class="card-text"><b>{{$product->category->image}}</b></p> 
            </div>
        </div>
        @endforeach
    </div>
