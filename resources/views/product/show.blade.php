...
<div style="padding: 20px; margin-top: 20px; width: 100%; border: 1px solid #777777">
    <a style="margin: 10px 0px; color: #777777; text-transform: uppercase">{{$product->name}}</a><br>
    <a>Home / Shop / </a><a style="color:#43A316">{{$product->name}}</a>
</div>
...
<form style="width: 100%; margin-top: 50px" action = "/shop/show/{{$product->name}}" method="get" class="row g-3">
    ...
    <div style="width:50%; float: left; padding: 65px 20px 0 20px; ">
        ...
        <button class="bi bi-cart " style="float: left; margin-left: 10px; border:none; height: 40px; width: 200px; background-color: #43A316; color: white; font-size: 20px" name="muahang">
            <a href="" style="color:white; margin-left: 5px; text-decoration: none; font-size: 16px">Add to cart</a>
        </button>
    </div>
