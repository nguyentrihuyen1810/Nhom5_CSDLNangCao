    ...
    <div class="header1">
        <ul>
            ...
            <li>
                ...
                <a style="float: left; margin-left: 15px" href="login">My Account</a>
            </li>
...
<div style="float:left">
    <!--Tab items-->
    <div class="tabs" style="margin-left: 480px;">
...
<div style = "background-color: #EDE9E9; height: 1160px; width: 100%; float: left; margin-top: 50px">
    ...
    <div id="carouselExampleInterval1" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="4000">
                <div class="card mb-3" style="width: 940px; margin-left: 290px; height: 300px">
                    <div class="row g-0">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><b>Apple iPhone 7 Plus Review</b></h5><br>
            ...
            <div class="carousel-item" data-bs-interval="4000">
                <div class="card mb-3" style="width: 940px; margin-left: 290px; height: 300px">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><b>Samsung Galaxy Z Fold3</b></h5><br>
...
<?php /**PATH C:\xampp\htdocs\testweb\web\resources\views/home.blade.php ENDPATH**/ ?>