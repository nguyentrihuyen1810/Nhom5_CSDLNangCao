...
<div class="sidebar">
    ...
    <form style="width: 70%; margin-left: 450px; margin-top: 50px" action = "/admin/update/{{$product->code}}" method="post" class="row g-3">
        @csrf
        ...
        <div class="col-md-6" style="float:left; margin-left: 20px; width: 20%">
                ...
                <input type="number" name = "price" value="{{$product->price}}" placeholder="Product price..." class="form-control" id="inputPassword4">
        </div>
        <div class="col-md-6" style="float: left; width: 40%">
        ...
        <div class="col-md-6" style="float:left; margin-left: 20px; width: 20%">
            ...
            <input type="number" name = "quantity" value="{{$product->quantity}}" placeholder="Product quantity..."  class="form-control" id="inputPassword4">
        </div>
        ...
        <div class="col-md-6" style="clear: both; margin-top: 20px; width: 62%">
            ...
            <textarea class="form-control"  placeholder="Description..." id="floatingTextarea" name="description">{{$product->description}}</textarea>
        </div>
